function loadCategories() {
  ...
  fetch("https://localhost:7260/api/Categories/GetCategories")
...
function createCategory() { 
    ...
    if (form) {
        form.addEventListener("submit", (event) => {
            ...
            fetch("https://localhost:7260/api/Categories/CreateCategory", {
                method: "POST",
                body: data,
...
function updateCategoryPost(event){
  ...
  fetch("https://localhost:7260/api/Categories/UpdateCategory", {
    method: "PUT",
    body: data
  }).then((response) => console.log(response))
  .then(() => {
...
function deleteCategory(id){
  ...
  if(result){
    fetch("https://localhost:7260/api/Categories/DeleteCategory?id=" + id, {
      method: "DELETE"
    }).then(() => {
      loadCategories()
    }).catch(error => console.log(error))
